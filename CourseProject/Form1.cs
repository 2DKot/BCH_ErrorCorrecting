...
namespace Lab7
{
    public partial class Form1 : Form
    {
        ...
        {
            MessageBox.Show("Эта программа разработана в ходе курсовой работы по теме"+
                "\r\n\"Коды БЧХ: обнаружение и исправление ошибок\"."
                +"\r\nРаботу выполнил: Байдин Константин,\r\nстудентом группы 13-КБ-ПР1");
        }
